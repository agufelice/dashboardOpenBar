...
import imagenFondo from '../assets/images/ultimoingreso.jpg';
...
class Product extends React.Component {
    ...
    async componentDidMount() {
        try {
            let productsfetch = await fetch('http://localhost:3001/api/products')
            let usersfetch = await fetch('http://localhost:3001/api/users')
